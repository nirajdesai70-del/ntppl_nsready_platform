...
**Date**: Sat Nov 22 01:32:11 IST 2025
**Environment**: docker
...
ab46b95e2ae4   ntppl_nsready_platform-admin_tool          "uvicorn app:app --h…"   57 minutes ago   Up 57 minutes   0.0.0.0:8000->8000/tcp, [::]:8000->8000/tcp                                                                                 admin_tool
...
Collector health: {"service":"ok","queue_depth":0,"db":"connected","queue":{"consumer":"ingest_workers","pending":0,"ack_pending":0,"redelivered":4,"waiting_pulls":4}}
...
- HTTP Status: 422
- Response: ``
- Result: ⚠️  **PARTIAL** - Rejected but error message doesn't match
