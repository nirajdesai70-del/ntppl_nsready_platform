...
Timestamp: 20251111_173156
Namespace: nsready-tier2

NAME                                      READY   STATUS             RESTARTS         AGE
admin-tool-65c7657fb4-4zmlr               1/1     Running            4 (15h ago)      16h
admin-tool-65c7657fb4-p7wdp               1/1     Running            4 (15h ago)      16h
collector-service-5c867cbffc-gd7sx        0/1     Running            11 (44s ago)     8h
collector-service-5c867cbffc-q8pcc        0/1     CrashLoopBackOff   20 (2m16s ago)   8h
collector-service-9676bc669-qppll         0/1     Running            3 (11s ago)      6m6s
grafana-74cb8f5b9b-b769z                  1/1     Running            2 (27m ago)      16h
nsready-db-0                              1/1     Running            0                7m14s
nsready-nats-0                            0/1     Pending            0                3m47s
...
Collector health: {"service":"ok","queue_depth":10,"db":"connected"}
...
Rows before: 10
Ingest response: {"status":"queued","trace_id":"14555de9-910a-45ee-9cb6-b7040a1194a7"}
Rows after:  10
...
ingest_events_total{status="queued"} 140.0

ingest_queue_depth:
ingest_queue_depth 117.0

ingest_errors_total:
ingest_errors_total{error_type="database"} 6.0
...
| Golden-path ingest | rows increase | before=10, after=10 | ❌ |
...
- Collector: {"service":"ok","queue_depth":10,"db":"connected"}
