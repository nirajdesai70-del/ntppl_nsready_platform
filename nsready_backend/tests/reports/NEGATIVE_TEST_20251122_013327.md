...
**Date**: Sat Nov 22 01:33:27 IST 2025
**Environment**: docker
...
ab46b95e2ae4   ntppl_nsready_platform-admin_tool          "uvicorn app:app --h…"   59 minutes ago   Up 59 minutes   0.0.0.0:8000->8000/tcp, [::]:8000->8000/tcp                                                                                 admin_tool
...
Collector health: {"service":"ok","queue_depth":0,"db":"connected","queue":{"consumer":"ingest_workers","pending":0,"ack_pending":0,"redelivered":8,"waiting_pulls":4}}
